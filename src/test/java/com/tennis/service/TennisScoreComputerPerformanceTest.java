...
/**
 * Performance tests for TennisScoreComputer to ensure efficiency
 */
class TennisScoreComputerPerformanceTest {
    ...
    void testLargeNumberOfGames() {
        ...
        assertTrue(duration < 5000, 
            "Processing 1000 games took " + duration + "ms, should be under 5000ms");
    ...
    void testVeryLongSingleGame() {
        ...
        assertTrue(duration < 1000, 
            "Very long game took " + duration + "ms, should be under 1000ms");
    ...
    void testMemoryUsage() {
        ...
        for (int i = 0; i < 10000; i++) {
            ...
            if (i % 1000 == 0) {
                ...
                assertTrue(memoryIncrease < 50 * 1024 * 1024, 
                    "Memory usage increased by " + (memoryIncrease / 1024 / 1024) + "MB after " + i + " games");
            }
        }
        ...
        System.out.println("Memory increase after 10,000 games: " + (totalIncrease / 1024 / 1024) + "MB");
    }
    ...
    void testConsistency() {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            if (firstResult == null) {
                ...
                assertEquals(firstResult, currentResult, 
                    "Game " + i + " produced different result than first game");
            }
        }
    }
    ...
    void testAlternatingWinsPerformance() {
        ...
        assertTrue(duration < 2000, 
            "Alternating game took " + duration + "ms, should be under 2000ms");
    }
}