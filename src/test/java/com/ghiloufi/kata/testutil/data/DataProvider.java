...
public final class DataProvider {
  ...
  public static Stream<Object[]> quickWinScenarios() {
    return Stream.of(
        new Object[]{"AAAA", (java.util.function.Predicate<com.ghiloufi.kata.domain.TennisGameState>) com.ghiloufi.kata.testutil.helpers.GameStateMatchers::isGameWonA, "Player A wins the game", new String[]{"Player A : 15 / Player B : 0", "Player A : 30 / Player B : 0", "Player A : 40 / Player B : 0", "Player A wins the game"}},
        new Object[]{"BBBB", (java.util.function.Predicate<com.ghiloufi.kata.domain.TennisGameState>) com.ghiloufi.kata.testutil.helpers.GameStateMatchers::isGameWonB, "Player B wins the game", new String[]{"Player A : 0 / Player B : 15", "Player A : 0 / Player B : 30", "Player A : 0 / Player B : 40", "Player B wins the game"}}
    );
  }

  public static Stream<Object[]> advantageScenarios() {
    return Stream.of(
        new Object[]{"ABABABA", (java.util.function.Predicate<com.ghiloufi.kata.domain.TennisGameState>) com.ghiloufi.kata.testutil.helpers.GameStateMatchers::isAdvantageA, "Player A : 40 / Player B : 40 (Advantage Player A)"},
        new Object[]{"ABABABAB", (java.util.function.Predicate<com.ghiloufi.kata.domain.TennisGameState>) com.ghiloufi.kata.testutil.helpers.GameStateMatchers::isDeuce, "Player A : 40 / Player B : 40 (Deuce)"}
    );
  }
  ...
  public static Stream<TennisTestCase> complexGameScenarios() {
    return Stream.of(
        ...
        TennisTestCase.advantageA("ABABABA", "Player A : 40 / Player B : 40 (Advantage Player A)", 7)
    );
  }
